    ...
    variants: {
      variant: {
        ...
        outline:
          ...
          clientHeader:
          'border border-input text-[9pt] bg-background dark:text-zinc-400 dark:hover:text-zinc-100 hover:border-black/20 dark:border-white/5 dark:hover:border-white/10 dark:bg-zinc-950/60 py-5 px-2 tracking-wide transition duration-500 ease-in-out active:opacity-50 group',
        secondary:
